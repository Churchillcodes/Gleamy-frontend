...
export default function Input({
  ...
  const baseInputStyles =
    "w-full px-4 py-2.5 rounded-xl border bg-white text-charcoal-text font-sans text-sm transition-all outline-none focus:ring-2";
  ...
  return (
    <div className={`flex flex-col gap-1.5 w-full ${className}`}>
      {label && (
        <label
          htmlFor={name}
          className="text-xs font-semibold text-walnut-brown tracking-wide flex items-center"
        >
          {label}
